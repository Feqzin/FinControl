...
export const futurePurchaseTimelineSnapshotSchema = z.object({
  ...
  vacationSuspendedIncome: nonNegativeNumber.optional().default(0),
  vacationPayIncome: nonNegativeNumber.optional().default(0),
...
export const futurePurchaseSimulationUpsertBody = z.object({
  ...
  includeVacationPlans: z.boolean().optional().default(false),
