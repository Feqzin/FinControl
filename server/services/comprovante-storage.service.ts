import { ENV } from "../env";
import { FilesystemComprovanteStorageAdapter } from "./filesystem-comprovante-storage.adapter";
import { SupabaseComprovanteStorageAdapter } from "./supabase-comprovante-storage.adapter";
import { hasSupabaseStorageConfig } from "./supabase-storage.client";
import type {
  ComprovanteStorage,
  PersistComprovanteInput,
  PersistComprovanteOutput,
} from "./comprovante-storage.contract";
import { getAllowedComprovanteMimeTypes as getAllowedComprovanteMimeTypesShared } from "./comprovante-storage.shared";
