...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 max-w-full items-center justify-center overflow-x-auto overflow-y-hidden rounded-md bg-muted p-1 text-muted-foreground [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] [&::-webkit-scrollbar]:hidden",
      className
    )}
    {...props}
  />
